                                                    ...
                                                    <?php  foreach($memberships as $key => $newC) { ?>
                                                        <tr>
                                                            ...
                                                            <td class="td-actions text-right">
                                                                ...
                                                                <button type="button" rel="tooltip" title="<?php echo $this->lang->line("remove_membership"); ?>" class="btn btn-danger btn-sm btn-link" data-target="#delete_membership-<?php echo $newC['membership_no'];?>" id="remove-memberships<?php echo $newC['membership_no'];?>" data-toggle="modal">
                                                                    <i class="material-icons">remove_circle</i>
                                                                </button>|
                                                                <button type="button" rel="tooltip" title="<?php echo $this->lang->line("block_membership"); ?>" class="btn btn-danger btn-sm btn-link" data-target="#block_membership-<?php echo $newC['membership_no'];?>" id="block-memberships<?php echo $newC['membership_no'];?>" data-toggle="modal">

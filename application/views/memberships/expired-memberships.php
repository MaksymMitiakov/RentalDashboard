                                ...
                                <div class="tab-pane active">
                                    <div class="card">
                                        <div class="card-header card-header-primary">
                                            <h4 class="card-title mt-0"><?=$this->lang->line('active_memberships_table')?></h4>
                                            <p class="card-category"> <?=$this->lang->line('below_is_the_list_of_active_memberships')?></p>
                                        </div>
                                        <div class="card-body container-fluid">
                                            <div class="table-responsive">
                                                <table class="table table-hover" id="active_membership_table">
                                                        ...
                                                        <?php foreach ($memberships as $key => $newC) { ?>
                                                            <tr>
                                                                ...
                                                                <td class="td-actions text-right">
                                                                    <button type="button" rel="tooltip" title="<?=$this->lang->line('view_membership');?>" class="btn btn-info btn-sm btn-link" data-target="#memberships-<?php echo $newC['membership_no']; ?>" data-toggle="modal">
                                                                        <i class="material-icons">visibility</i>
                                                                    </button>|

                                                                    <button type="button" rel="tooltip" title="<?=$this->lang->line('edit_membership');?>" class="btn btn-primary btn-sm btn-link" data-target="#update_membership-<?php echo $newC['membership_no']; ?>" data-toggle="modal">
                                                                        <i class="material-icons">edit</i>
                                                                    </button>|
                                                                    <button type="button" rel="tooltip" title="<?=$this->lang->line('remove_membership');?>" class="btn btn-danger btn-sm btn-link" data-target="#delete_membership-<?php echo $newC['membership_no']; ?>" id="remove-memberships<?php echo $newC['membership_no']; ?>" data-toggle="modal">
                                                                        <i class="material-icons">remove_circle</i>
                                                                    </button>|
                                                                    <button type="button" rel="tooltip" title="<?=$this->lang->line('block_membership');?>" class="btn btn-danger btn-sm btn-link" data-target="#block_membership-<?php echo $newC['membership_no']; ?>" id="block-memberships<?php echo $newC['membership_no']; ?>" data-toggle="modal">
                                                            ...
                                                            <div class="modal fade" id="delete_membership-<?php echo $newC['membership_no']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <p><?=$this->lang->line('remove_membership_confirm');?></p>
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <button type="button" class="btn btn-danger membershipDelete" id="<?php echo $newC['membership_no']; ?>"><?=$this->lang->line('remove');?></button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!-- End of modal -->
                                                            <!-- Modal for block memberships -->
                                                            <div class="modal fade" id="block_membership-<?php echo $newC['membership_no']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title font-weight-bold" id="exampleModalLabel"><?=$this->lang->line('block_membership');?></h5>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                <span aria-hidden="true">&times;</span>
                                                                            </button>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <p><?=$this->lang->line('block_membership_confirm');?></p>
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn btn-primary" data-dismiss="modal"><?=$this->lang->line('cancel');?></button>
                                                                            <button type="button" class="btn btn-danger membershipBlock" id="<?php echo $newC['membership_no']; ?>"><?=$this->lang->line('block');?></button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-md-4">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <select id="vendor_id" name="vendor_id" class="form-control vendor_id<?php echo $newC['membership_no']; ?>">
                                                                                                    <?php if ($newC['user_id'] == "") { ?>

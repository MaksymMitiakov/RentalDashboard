        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title font-weight-bold text-primary"><?php echo $this->lang->line("change_password"); ?></h5>
                    ...
                    <form id="change_pass_form">
                        <div class="col-md-12">
                            <div class="form-group mt-4">
                                <label class="bmd-label-floating"><?php echo $this->lang->line("username"); ?></label>
                                <input type="text" class="form-control pl-3 username" value="<?php echo $this->session->userdata('username'); ?>" name="username" readonly>
                            </div>
                            <div class="form-group mt-4">
                                <label class="bmd-label-floating"><?php echo $this->lang->line("enter_new_password"); ?></label>
                                <input type="password" name="new_pass" class="form-control pl-3 new_pass">
                            </div>
                            <div class="form-group mt-4">
                                <label class="bmd-label-floating"><?php echo $this->lang->line("confirm_password"); ?></label>
                                <input type="password" name="conf_pass" class="form-control pl-3 conf_pass">
                            </div>
                        </div>
                    </form>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-secondary btn-round btn-sm" data-dismiss="modal"><i class="material-icons">cancel</i><?php echo $this->lang->line("cancel"); ?></button>
        ...
        <div class="container">
            <div class="row">
              <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="copyright"><?php echo $this->lang->line("a2020"); ?> <a href="#"><?php echo $this->lang->line("mobilM"); ?></a> <?php echo $this->lang->line("all_rights_reserved"); ?>.</div>
                </div>
                <div class="col-md-2">
                  <a href="https://www.iyzico.com"><img src="<?php echo base_url(); ?>assets/images/iyzico.png" height="40" width="80" /></a>
                </div>
                <div class="col-md-2">
                  <a href="#"><img src="<?php echo base_url(); ?>assets/images/visa.png" height="40" width="100" /></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- slideshow -->
    <?php $site = $_SERVER['REQUEST_URI']; if (strpos($site, 'create-homes') || strpos($site, 'homes-info')) { ?>
        <script src="<?php echo base_url(); ?>assets/js/slideshow/slideshow.js"></script>
    <?php } ?>
    <!-- ~slideshow---->
    <?php $site = $_SERVER['REQUEST_URI']; ?>
    <?php $site1 = 'reports'; ?>
    <?php if (strpos($site, $site1) || strpos($site, 'promissory') || strpos($site, 'invoice')) { ?>
    ...
    <?php if($this->session->userdata("site_lang") == "turkish") { ?>
        <script src="<?php echo base_url(); ?>assets/js/language/turkish/ps_lang.js"></script>
    <?php } else { ?>
        <script src="<?php echo base_url(); ?>assets/js/language/english/ps_lang.js"></script>
    <?php } ?>
